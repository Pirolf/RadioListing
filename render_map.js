...
jQuery(document).ready(function() {
    ...
    function initialize() {
        ...
        request.open("GET", "http://yt.argusinvent.com/wp-content/plugins/radio-listing/radiostations.xml", false);
        request.send();
        ...
        for (var i = 0; i < radios.length; i++) {
            ...
            if (station_addr[0].firstChild !== null && station_lat !== null && station_long !== null) {
                ...
                var curr_info = "<h4>" + radio_name + "</h4>" +
                        "<div class='radio_addr'>" + radio_addr + "</div>" +
                        "<div calss='freq'>Frequency: " + radio_freq + "</div>" +
                        "<div class='casttime'>Cast Time: " + radio_casttime + "</div>";
