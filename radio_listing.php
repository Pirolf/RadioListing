...
include(RL_PATH . "curl_test.php");
include(RL_PATH . "ui_test.php");
include(RL_PATH . "searchRadioHandler.php");
if (!function_exists('rl_ajaxurl')) {
    add_action('wp_head', 'rl_ajaxurl');
...
function rl_enqueue_scripts() {
  ...
  //  wp_enqueue_script("jquery_ui", "http://code.jquery.com/ui/1.10.4/jquery-ui.js", array("jquery", "jquery_ui_css"));
    ...
    if (is_page("curl-test")) {
        ...
        wp_enqueue_script("searchRadio", RL_URL . "searchRadioAjax.js", array("google_map_api", "google_map_sphereDist", "render_map"));
